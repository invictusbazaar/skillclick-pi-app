...
interface Props {
  orderId: string;
  myUsername: string;
  targetRole: "Buyer" | "Seller"; // Koga ocenjujemo (Kupca ili Prodavca)
}
...
export default function ReviewModal({ orderId, myUsername, targetRole }: Props) {
  ...
  const handleSubmit = async () => {
    ...
    try {
        ...
        alert(T('success'));
        setIsOpen(false);
        router.refresh(); // Osveži stranicu da se vidi da je ocenjeno
