...
const MOCK_USERS = [
  ...
  { id: 2, username: "marko_k", email: "marko@example.com", role: "user", status: "active" },
  { id: 3, username: "scammer_99", email: "scam@bad.com", role: "user", status: "reported" },
  { id: 4, username: "ana_design", email: "ana@design.com", role: "user", status: "active" },
  { id: 5, username: "darko_dev", email: "darko@code.com", role: "user", status: "banned" },
];
