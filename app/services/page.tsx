      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-3xl p-6 md:p-10 shadow-sm border border-gray-100 mb-10 relative overflow-hidden">
            ...
            <div className="relative flex flex-col md:flex-row items-start md:items-end gap-6 pt-10">
                ...
                {/* DODATO: flex-shrink-0 da se avatar ne smanjuje */}
                ...
                <div className="flex-grow z-10 pb-2 w-full md:w-auto min-w-0">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        {/* DODATO: flex-shrink-0 da dugmići ostanu cele širine */}
        ...
        <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
            {t('sellerGigs')} <span className="text-purple-600 truncate max-w-[200px]">@{username}</span> {/* ✅ PREVEDENO */}
        </h2>
